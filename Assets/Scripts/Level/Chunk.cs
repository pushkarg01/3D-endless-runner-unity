...
{
    [SerializeField] GameObject fencePrefab, applePrefab,coinPrefab;

    [SerializeField] float appleSpawnChance = .5f;
    [SerializeField] float coinSpawnChance = .5f;
    [SerializeField] float coinSeperationLength = 2f;

    [SerializeField] float[] lanes = { -2.3f, 0f, 2.5f };
    ...
    public void Init(LevelGengerator levelGengerator, ScoreManager scoreManager)
    {
